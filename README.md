...
2.  **Clone the Repo:** ```bash
    git clone [https://github.com/arawrdn/clarity-4-modular-dao](https://github.com/arawrdn/clarity-4-modular-dao)
...
1.  **Install Clarinet:** Follow the official Stacks Labs guide.
2.  **Clone the Repo:** ```bash
    git clone [https://github.com/your-username/clarity-4-modular-dao](https://github.com/your-username/clarity-4-modular-dao)
    cd clarity-4-modular-dao
    ```
3.  **Run Tests:**
    ```bash
